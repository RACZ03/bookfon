...
export class ConnectionService {
  ...
  send(type: string, path: string, params: any = null): Promise<any> {
    ...
    let promise = new Promise((resolve, reject) => {
      switch(type) {
        case 'get':
          this.http.get<any>(`${ URL }/api/${ path }`, { headers: headers })
                  .subscribe({
                    next: (response: any) => {
                      resolve(response);
                    },
        ...
        case 'post':
          this.http.post<any>(`${ URL }/api/${ path }`, params, { headers: headers })
                  .subscribe({
                    next: (response: any) => {
                      resolve(response);
                    },
        ...
        case 'put':
          this.http.put<any>(`${ URL }/api/${ path }`, params, { headers: headers })
                  .subscribe({
                    next: (response: any) => {
                      resolve(response);
                    },
        ...
        case 'delete':
          this.http.delete<any>(`${ URL }/api/${ path }`, { headers: headers })
                  .subscribe({
                    next: (response: any) => {
                      resolve(response);
                    },
